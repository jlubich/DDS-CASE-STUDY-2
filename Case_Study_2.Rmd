...
library(gridExtra)
```
```{r DirectorySett, eval=FALSE}
## Initialize Directory
setwd(dirname(rstudioapi::getActiveDocumentContext()$path))
```
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Data Visualization/Exploration:**  The first step in the analysis process is to load the data-set and review its contents.  The best methods for this are visually looking at the data.  
...
**Data Cleaning:** After reviewing the original data-set, the data appears very well organized and complete, with very few missing observations. 
...
```
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Baseline Analysis:**  The main focus of the EDS was employee attrition rates and what factors may be contributing factors.  
first step in the analysis process is to load the data-set and review its contents.  The best methods for this are visually looking at the data.  
