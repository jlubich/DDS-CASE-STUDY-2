...
The following visualizations show the attrition rate of the main variables of the dataset. The height of the bars indicates the attrition percetange for that data point. The width of the bars indicates the relative overall number of employees who are in those categories.
...
**Analysis of Age**  
Upon reviewing the above graphical analysis of the data set, based on attrition rates, our first category we analyzed was Attrition Rate by Employee Age Groups. The percentage of attrition values were developed by dividing the total number of attrition in an age group by the total number of employees in that age group. The width of the bars represent the portion of the total number of attrition.   
...
The next category we analyzed was Attrition Rate by Job Involvement. The percentage of attrition values were developed by dividing the total number of attrition by the employees corresponding Job Involvement score by the total number employee with corresponding Job Involvement scores. The width of the bars represent the portion of the total number of attrition.  
...
Validity of Income Datafields
Reasons for Attrition
How are Employee survey information collected.
Bias in Employee Ratings
