...
**Fig 1.2 Summary Statistics:** contains statistical summaries of each catagort (mean, median, min/max, etc.).  This give the team a high-level understanding of what is included in the dataset.

: **Table 1.1** (Variables - Classifications/Observations)  
